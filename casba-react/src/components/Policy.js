...
class Policy extends React.Component {
  ...
  render() {
    return (
      <div className=''>
        Your right to privacy and security is very important to us. We, Josla Electric Company ("Josla"),
        treat personal information obtained through the use of this website as private and confidential and
        are committed to providing you with secure access to our online services.
        How we use the personal information we collect. We need to collect personal or other information
        if we are to meet our obligations to you, to follow your instructions, to inform you of new services and to ensure that our business is geared towards your needs.
        ...
        Different online services and Josla entities may have their own privacy and security policies because the nature of their service or products demand a deviation from our general policy. These specific policies will apply to and exclusively govern your use of the particular online service.
        ...
        If you have any questions about this privacy and security statement please email us on corporate@josla.com.ng.
      </div>
    );
  }
}
